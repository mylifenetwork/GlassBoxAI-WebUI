...
function ModalAlert({case_number="121",name="braking"}) {
  ...
  return (
    <View>
      <Button onPress={toggleModal} customStyle={[{width:w*0.95}]}>
        <View style={styles.rowContainer}>
          <Text style={styles.ButtonText}>
          Wrong alert?
        </Text>
        <Image style={styles.buttonImage} source={require("../../assets/Images/alertSmall.png")}></Image>
        </View>
      ...
      <Modal isVisible={isModalVisible}>
        <View style={styles.window}>
            ...
            <Text style={styles.title}>Wrong Alert?</Text>
            ...
            <Text numberOfLines={2} style={styles.detail}>Are you decide to report this error?</Text> 
            <View style={styles.rowContainer}>
