  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{justifyContent: "space-evenly",alignContent: "center"}}>
        <TouchableOpacity style={styles.buttonContainerB} onPress={async () => {
          signOut(auth).then(() => {
            // Sign-out successful.
            alert("has logout")
            backtoHome()
